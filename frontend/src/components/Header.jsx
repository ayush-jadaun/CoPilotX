...
const Header = ({ responses, startupIdea, darkMode = true, onNewIdea, onSettings }) => {
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-16">
          ...
          <nav className="hidden md:flex items-center space-x-4">
            <button 
              onClick={onNewIdea}
              className={`btn-futuristic flex items-center px-4 py-2 text-sm font-medium rounded-lg transition-all duration-300 scale-hover hover-glow-blue ${
                darkMode 
            ...
            <button
              ...
              className={`btn-futuristic flex items-center px-4 py-2 text-sm font-medium rounded-lg transition-all duration-300 disabled:opacity-50 disabled:cursor-not-allowed scale-hover hover-glow-green ${
                darkMode 
                  ? 'text-white/90 hover:text-white' 
                  : 'text-gray-700 hover:text-gray-900 bg-white/50 hover:bg-white/80'
              }`}
            ...
            <button 
              onClick={onSettings}
              className={`btn-futuristic flex items-center px-4 py-2 text-sm font-medium rounded-lg transition-all duration-300 scale-hover hover-glow-purple ${
                darkMode 
                  ? 'text-white/90 hover:text-white' 
                  : 'text-gray-700 hover:text-gray-900 bg-white/50 hover:bg-white/80'
              }`}
          ...
          <div className="md:hidden">
            <button
              ...
              className={`p-2 rounded-lg transition-all duration-300 scale-hover ${
                darkMode 
          ...
          <div className="md:hidden">
            <div className={`rounded-lg mt-2 p-4 space-y-2 ${
              ...
              <button 
                ...
                className={`btn-futuristic flex items-center w-full px-3 py-2 text-sm font-medium rounded-lg transition-all duration-300 scale-hover ${
                  darkMode 
                    ? 'text-white/90 hover:text-white' 
              ...
              <button
                ...
                disabled={isDownloading}
                className={`btn-futuristic flex items-center w-full px-3 py-2 text-sm font-medium rounded-lg transition-all duration-300 disabled:opacity-50 disabled:cursor-not-allowed scale-hover ${
                  darkMode 
                    ? 'text-white/90 hover:text-white' 
                    : 'text-gray-700 hover:text-gray-900'
                }`}
