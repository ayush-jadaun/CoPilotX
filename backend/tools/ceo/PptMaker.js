...
class PPTMakerTool extends Tool {
  name = "ppt_maker";
  description =
    "Creates professional PowerPoint presentations with multiple slide types, themes, and formatting options. Perfect for business presentations, pitch decks, and reports.";
